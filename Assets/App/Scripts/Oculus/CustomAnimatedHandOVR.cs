...
namespace App.Scripts.Oculus
{
    public class CustomAnimatedHandOVR : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            _pointBlend = Mathf.Lerp(_pointBlend, _pointTarget, _animPointAndThumbsUpGain * Time.deltaTime) + 0.15f; //dirty hack
        ...
        private void UpdateAnimStates()
        {
            ...
            float flex = 0.9f;//OVRInput.Get(OVRInput.Axis1D.PrimaryHandTrigger, _controller);
            //dirty hack
